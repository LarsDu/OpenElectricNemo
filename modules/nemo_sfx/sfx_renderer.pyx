...
#from kivent_core.systems.renderers cimport RotateRenderer, RenderStruct
...
#from sfx_formats cimport VertexFormatSfx1
#from sfx_formats import vertex_format_sfx1
